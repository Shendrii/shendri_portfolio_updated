    ...
    <section id="blog" className="px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <a
          ...
          className="group mb-10 block overflow-hidden rounded-2xl border border-zinc-200 bg-white transition-all duration-300 hover:-translate-y-1 hover:border-sky-300 hover:shadow-lg hover:shadow-sky-500/5 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-sky-700"
        >
